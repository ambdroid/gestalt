...
HELPMSG = (
        ...
        "some of which are restricted to a server, while others are not.\n"
        ...
        "`{p}swap (proxy id/prefix) close`: unilaterally closes the Swap\n"
        "\n"
        "**Collectives**: (shortcut `{p}c`)\n"
        "`{p}collective new (@role/everyone)`: create a new Collective. "
        "Requires **Manage Roles**.\n"
        "`{p}collective (id) (name)`: available to everyone with the role.\n"
