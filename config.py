...
HELPMSGS = {
        ...
        'Collectives kinda suck because they are limited to a single server. '
        'They will eventually be removed and converted into...\n'
        '- :performing_arts:**Masks:** A Mask is like a Collective but without '
        'being tied to a role or server. They are governed by a customizable '
        'set of rules that controls who can join, change appearance, etc.\n'
