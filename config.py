...
HELPMSG = (
        ...
        'A proxy is used by typing customizable tags around your messages. '
        ...
        '`{p}proxy (id) tags [tags]`: set tags\n'
        '`{p}proxy (id) auto (on/off/blank)`: set autoproxy\n'
        '\n'
        '**Swaps**: (shortcut `{p}s`)\n'
        '`{p}swap open (@user) [tags]`: open a Swap\n'
        '`{p}swap close (proxy id/tags)`: unilaterally closes the Swap\n'
        '\n'
