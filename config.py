...
REACT_FIRST = "\N{BLACK LEFT-POINTING DOUBLE TRIANGLE}"
REACT_PREV = "\N{BLACK LEFT-POINTING TRIANGLE}"
REACT_NEXT = "\N{BLACK RIGHT-POINTING TRIANGLE}"
REACT_LAST = "\N{BLACK RIGHT-POINTING DOUBLE TRIANGLE}"

# exactly what PK uses
REPLY_SYMBOL = (
    "\N{THREE-PER-EM SPACE}" "\N{LEFTWARDS ARROW WITH HOOK}" "\N{VARIATION SELECTOR-16}"
)
...
HELPMSGS = {
    ...
    "pluralkit": "**PluralKit Swaps**: (shortcut `{p}pk`)\n"
    ...
    "autoproxy": "**Autoproxy**: (shortcut: `{p}ap`)\n"
