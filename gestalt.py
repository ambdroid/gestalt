...
HELPMSG = ("`" + COMMAND_PREFIX + "prefix`: **set a custom prefix**\n"
        ...
        "Examples:\n"
        "`prefix =`: proxy with `=hello!`\n"
        "`prefix \"h \"`: proxy with `h hello!`\n"
        "`prefix delete`: revert your prefix to the defaults\n"
        "\n"
        "`" + COMMAND_PREFIX + "prefs`: **user preferences**\n"
        "- auto: proxy all your messages *except* those that are prefixed. "
        "(shortcut: `" + COMMAND_PREFIX + "auto`)\n"
        "- replace: convert singular pronouns to plural. (default: **on**)\n"
        "- autoswap: automatically accept any Swap. (see below)\n"
        "Use `prefs [name] [on/off]`, or `prefs [name]` to toggle.\n"
        "Use `prefs` by itself to list your current preferences.\n"
        "Use `prefs defaults` to reset your preferences.\n"
        "\n"
        "`swap [user]`: **initiate or consent to a Swap**\n"
        ...
        "\n"
        "`" + COMMAND_PREFIX + "nick`: **change this bot's nick**\n"
